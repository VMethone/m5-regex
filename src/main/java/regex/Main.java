...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // Using lookaheads to check all conditions in a single regex
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Regex matches: one or more non-whitespace characters, followed by @,
        // optionally followed by "mail.", then "utoronto.ca"
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Regex: any characters, followed by a capital letter (captured),
        // followed by any characters, followed by the same capital letter (backreference)
